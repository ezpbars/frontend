...
/**
 * progress bar
 * @typedef {ReplicaListener & ListenerOf.<string, "userSub"> & ListenerOf.<string, "uid"> & ListenerOf.<string, "name"> & ListenerOf.<number, "samplingMaxCount"> & ListenerOf.<number, "samplingMaxAgeSeconds"> & ListenerOf.<"systematic" | "simpleRandom", "samplingTechnique"> & ListenerOf.<Date, "createdAt"> & ListenerOf.<import("/js/app/progress_bars/steps/progress_bar_step.js").ProgressBarStep, "defaultStepConfig">} ProgressBar
 */
 ...
 */
export function parseProgressBar({ user_sub, uid, name, sampling_max_count, sampling_max_age_seconds, sampling_technique, created_at, default_step_config }) {
