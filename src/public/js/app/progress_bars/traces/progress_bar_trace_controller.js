...
export class ProgressBarTraceController {
    constructor() {
        ...
        this.reader.items.addArrayListenerAndInvoke(simpleArrayListener({
            insert: (index, progressBarTrace) => {
                ...
                this.itemsView.items.items.splice(index, 0, new ProgressBarTraceView(replica, this.onDelete.bind(this, replica)));
            },
            remove: (index) => {
        ...
        this.filterController = new ProgressBarTraceFiltersController(this.reader.filters.value, this.reader.sort.value);
    ...
    render() {
        this.element.appendChild(new Listing(this.itemsView, { element: document.createElement("div") }, this.filterController).element);
    }
}
